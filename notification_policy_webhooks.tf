resource "cloudflare_notification_policy_webhooks" "slack" {
  ...
  url        = var.cf_slack_general_webhook_url
  secret     = var.cf_slack_general_webhook_secret
...
resource "cloudflare_notification_policy_webhooks" "slack_tunnel" {
  ...
  url        = var.cf_slack_tunnel_webhook_url
  secret     = var.cf_slack_tunnel_webhook_secret
...
resource "cloudflare_notification_policy_webhooks" "slack_status" {
  ...
  url        = var.cf_slack_status_webhook_url
  secret     = var.cf_slack_status_webhook_secret
